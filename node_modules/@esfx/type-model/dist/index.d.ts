...
declare type strings255 = numbers255 extends infer T ? {
    [P in keyof T]: P;
} : never;
/**
 * Gets a union of the number and numeric string value for a number or numeric string index between 0 and 255
 */
export declare type numstr<I extends keyof any> = I extends numbers255[number] ? I | strings255[I] : I extends strings255[number] ? I | numbers255[I] : never;
/**
...
export declare type Falsey = Falsy;
/**
 ...
 */
export declare type IsAny<A> = (1 | 2) extends (A extends never ? 1 : 2) ? true : false;
/**
 * Maps to `true` if `A` is precisely the `never` type; otherwise, `false`.
 */
export declare type IsNever<A> = (A extends never ? true : false) extends true ? true : false;
/**
...
declare type __IsUnionRest<T, Q> = T extends unknown ? Not<SameType<[T], Q>> : never;
/**
...
declare type __EveryRest<R> = "never" extends R ? never : "false" extends R ? false : "boolean" extends R ? boolean : true;
/**
...
declare type __SomeRest<R> = "never" extends R ? never : "true" extends R ? true : "boolean" extends R ? boolean : false;
/**
...
declare type __OneRest<R> = "never" extends R ? never : "boolean" extends R ? boolean : IsNever<R> extends true ? false : IsUnion<R> extends true ? false : true;
/**
...
declare type __IsSubsetOf<Sub, Super> = IsNever<Sub> extends true ? true : IsNever<Super> extends true ? false : IsUnknown<Sub> extends true ? false : IsUnknown<Super> extends true ? true : [
    Sub
] extends [Super] ? true : false;
/**
...
declare type __DisjoinRest<T> = IsNever<T> extends true ? {} : T;
/**
