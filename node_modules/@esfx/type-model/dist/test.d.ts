 ...
 * ```
 */
export declare type Test<T extends {
    pass: true;
}> = T;
/**
 ...
 * ```
 */
export declare type ExpectType<Actual, Expected> = [
    IsNever<Expected>
] extends [true] ? [IsNever<Actual>] extends [true] ? {
    pass: true;
} : {
    pass: false;
    Expected: Expected;
    ...
    IsAny<Expected>
] extends [true] ? [IsAny<Actual>] extends [true] ? {
    pass: true;
} : {
    pass: false;
    Expected: Expected;
